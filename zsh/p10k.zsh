# Generated by Powerlevel10k configuration wizard on 2020-04-06 at 14:27 PDT.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 23879.
# Wizard options: awesome-patched + powerline, small icons, unicode, lean, 24h time,
...
() {
  ...
  # Color for icon
  # typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_VISUAL_IDENTIFIER_COLOR=209
  ...
  # Only show on java commands
  typeset -g POWERLEVEL9K_JAVA_VERSION_SHOW_ON_COMMAND='java|javac|jshell'
